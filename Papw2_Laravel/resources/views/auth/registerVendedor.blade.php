@extends('enterMain')
@section('form')
    <form role="form" class="form-body" method="POST" action="{{ route('register2') }}">
        @csrf
        <span class="text-center"><h2>Registrar Vendedor</h2></span>
...
@section('footer')
    ...
    <h4 class="text-center"  style="margin-bottom: 20px; ">¿Quieres solo comprar?</h4>
    <h4 class="text-center" ><a  href="{{route('register')}}" class="text-center"  style="margin-bottom: 20px; ">Registrate aqui!</a></h4>
@endsection